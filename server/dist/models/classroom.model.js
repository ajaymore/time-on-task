...
var ClassroomSchema = new _mongoose2.default.Schema({
  ...
  observations: [{ type: _mongoose2.default.Schema.Types.ObjectId, ref: 'Observation' }]
});

ClassroomSchema.post('remove', function () {
    ...
    return _regenerator2.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return _school2.default.findByIdAndUpdate(doc.school, {
              $pullAll: {
                classrooms: [doc._id]
              }
            });
...
ClassroomSchema.post('save', function () {
...
exports.default = _mongoose2.default.model('Classroom', ClassroomSchema);